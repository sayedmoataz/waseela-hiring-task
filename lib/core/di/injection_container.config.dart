...
import '../../features/bnpl/domain/usecases/calculate_installment_usecase.dart'
    as _i96;
import '../../features/bnpl/domain/usecases/create_order_usecase.dart' as _i165;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt configureDependencies({
    ...
    gh.factory<_i837.InstallmentBloc>(() => _i837.InstallmentBloc(
          gh<_i197.BnplRepository>(),
          gh<_i96.CalculateInstallmentUseCase>(),
        ));
    gh.factory<_i165.CreateOrderUseCase>(
        () => _i165.CreateOrderUseCase(gh<_i197.BnplRepository>()));
    gh.factory<_i936.OrderBloc>(() => _i936.OrderBloc(
          gh<_i165.CreateOrderUseCase>(),
